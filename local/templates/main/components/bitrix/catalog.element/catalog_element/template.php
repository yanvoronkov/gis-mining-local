<?php
/**
 * Шаблон карточки товара для ASIC-майнеров (IBLOCK_ID = 1)
...
<div class="product-desktop-grid container" id="app-root" data-iblock-id="1">
    <section class="product section-padding">
        ...
        ?>
        <h1 class="product__name section-title"><?= htmlspecialchars($product['NAME']) ?></h1>
        ...
        <div class="share-popup__content">
            ...
            <ul class="share-popup__social-list">
                <li class="share-popup__social-item">
                    <a href="https://t.me/share/url?url=<?= urlencode('https://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) ?>&text=<?= urlencode($arResult["NAME"]) ?>" target="_blank" rel="noopener noreferrer nofollow" class="share-popup__social-button">
                ...
                <li class="share-popup__social-item">
                    <a href="https://wa.me/?text=<?= urlencode($arResult["NAME"] . ' - https://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) ?>" target="_blank" rel="noopener noreferrer nofollow" class="share-popup__social-button">
                        <div class="share-popup__icon-wrapper">
                ...
                <li class="share-popup__social-item">
                    <a href="https://vk.com/share.php?url=<?= urlencode('https://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) ?>&title=<?= urlencode($arResult["NAME"]) ?>" target="_blank" rel="noopener noreferrer nofollow" class="share-popup__social-button">
                        <div class="share-popup__icon-wrapper">
                            <!-- Место для иконки VK -->
                ...
                <li class="share-popup__social-item">
                    <a href="https://connect.ok.ru/offer?url=<?= urlencode('https://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) ?>&title=<?= urlencode($arResult["NAME"]) ?>" target="_blank" rel="noopener noreferrer nofollow" class="share-popup__social-button">
                        <div class="share-popup__icon-wrapper">
                            <!-- Место для иконки OK -->
                ...
                <li class="share-popup__social-item">
                    <a href="mailto:?subject=<?= urlencode($arResult["NAME"]) ?>&body=<?= urlencode('Поделился статьей: ' . $arResult["NAME"] . ' - https://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']) ?>" class="share-popup__social-button">
                        <div class="share-popup__icon-wrapper">
            ...
            <div class="share-popup__copy-section">
                <div class="share-popup__copy-input-wrapper">
                    <input class="share-popup__copy-input" type="text" value="https://<?= $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>" readonly aria-label="Ссылка для копирования">
                </div>
                ...
                <div class="toast-notification" role="status" aria-live="polite">
                    ...
                    <button class="toast-notification__close btn" type="button" aria-label="Закрыть уведомление"></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-info__line">
                ...
                <a href="/razmeschenie/" target="_blank"><span class="card-info__text">Доступно размещение на хостинге GIS Mining</span></a>
            </div>
        </div>
...
<div class="product__price">
    ...
    <div class="product__found-cheaper js-open-popup-form"
         data-form-type="cheaper"
        ...
        Нашли дешевле?
            ...
            <div class="product__actions product-card"
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" class="quantity-selector__input js-quantity-value"
                           id="quantity-<?= $product['ID'] ?>" value="1" min="1" max="999"
...
?>">
  <div class="profit-calculator__wrapper">
    <div class="profit-calculator__container" id="profit-calculator">
      ...
      <input type="hidden" id="pc-device-price" value="<?=$profitCalculator['price'] ?: 0?>">
      <input type="hidden" id="pc-btcusd-rate" value="<?=isset($profitCalculator['cryptoUsdRates']['btc']) ? round($profitCalculator['cryptoUsdRates']['btc'], 2) : 0?>">
      <input type="hidden" id="pc-ltcusd-rate" value="<?=isset($profitCalculator['cryptoUsdRates']['ltc']) ? round($profitCalculator['cryptoUsdRates']['ltc'], 2) : 0?>">
      <input type="hidden" id="pc-dogeusd-rate" value="<?=isset($profitCalculator['cryptoUsdRates']['doge']) ? round($profitCalculator['cryptoUsdRates']['doge'], 2) : 0?>">
      <input type="hidden" id="pc-usdtrub-rate" value="<?=isset($profitCalculator['usdtRubRate']['current']) ? round($profitCalculator['usdtRubRate']['current'], 2) : 0?>">
      <input type="hidden" id="pc-btc-ffps" value="<?=isset($profitCalculator['cryptoFfps']['btc']) ? $profitCalculator['cryptoFfps']['btc'] : 4.1e-7?>">
      <input type="hidden" id="pc-ltc-ffps" value="<?=isset($profitCalculator['cryptoFfps']['ltc']) ? $profitCalculator['cryptoFfps']['ltc'] : 3.7975443?>">
      <input type="hidden" id="pc-doge-ffps" value="<?=isset($profitCalculator['cryptoFfps']['doge']) ? $profitCalculator['cryptoFfps']['doge'] : 0.00102614?>">
        ...
        <div class="profit-calculator__fields">
          <div class="profit-calculator__field profit-calculator__field--quantity">
            ...
            <div class="profit-calculator__field-input-wrapper">
              <input id="pc-quantity" name="pcQuantity" class="profit-calculator__field-input" type="number" inputmode="numeric" value="1" min="1" step="1" required>
          ...
          <div class="profit-calculator__field profit-calculator__field--power-price">
            ...
            <div class="profit-calculator__field-input-wrapper">
              <input id="pc-tariff" name="pcTariff" class="profit-calculator__field-input" type="number" inputmode="numeric" value="5.3" min="0" step="0.1" required>
              <span class="profit-calculator__field-unit">₽/кВт·ч</span>
            </div>
          </div>
        </div>

        <div class="profit-calculator__main-profit" style="display:none;visibility:hidden;opacity:0;height:0;">
          <div class="profit-calculator__main-label-value-wrap">
            ...
            <div class="profit-calculator__main-value highlighted-color preloader-block">
              <span id="pc-net-month" class="preloader-text">—</span> <span class="unit highlighted-color">₽</span>
            </div>
          </div>
          ...
          <div class="profit-calculator__secondary-profit">
            <div class="profit-calculator__secondary-item preloader-block">
              ...
              <div class="profit-calculator__secondary-value"><span id="pc-income-month" class="preloader-text">—</span> <span class="unit">₽</span></div>
            </div>
            <div class="profit-calculator__secondary-item preloader-block">
              <div class="profit-calculator__secondary-label">Расход в месяц</div>
              <div class="profit-calculator__secondary-value"><span id="pc-consumption-month" class="preloader-text">—</span> <span class="unit">₽</span></div>
            </div>
          </div>
        </div>
        ...
        <div class="profit-calculator__metrics" style="display:none;">
          <div class="profit-calculator__metric-card preloader-block">
            ...
            <div class="profit-calculator__metric-card-value highlighted-color">
              <span id="pc-profitability" class="preloader-text">—</span> <span class="unit">%/год</span>
            </div>
          </div>
        ...
        <div class="profit-calculator__fields">
          <?php if ($profitCalculator['coin'] == 'BTC') { ?>
            <div class="profit-calculator__field profit-calculator__field--exchange-rate-btc-used">
              ...
              <div class="profit-calculator__field-input-wrapper">
                <input name="exchangeRateBtcUsed" type="text" inputmode="numeric" class="profit-calculator__field-input" />
                <div class="profit-calculator__field-input-btn-icon profit-calculator-exchange-rate-btc-used-reset">
                  <svg width="24" height="24" viewBox="0 0 24 24"><path d="M2 12C2 16.97 6.03 21 11 21C13.39 21 15.68 20.06 17.4 18.4L15.9 16.9C14.63 18.25 12.86 19 11 19C4.76 19 1.64 11.46 6.05 7.05C10.46 2.64 18 5.77 18 12H15L19 16H19.1L23 12H20C20 7.03 15.97 3 11 3C6.03 3 2 7.03 2 12Z" fill="currentColor"></path></svg>
                </div>
              </div>
              <div class="profit-calculator__field-slider-wrapper profit-calculator__field-slider-wrapper--exchange-rate-btc-used" style="visibility:hidden;">
                <input name="exchangeRateBtcUsedDiffSlider" type="text" class="profit-calculator__field-slider">
              </div>
            </div>
          <?php } ?>
          <?php if ($profitCalculator['coin'] == 'LTC+DOGE') { ?>
            <div class="profit-calculator__field profit-calculator__field--exchange-rate-ltc-used">
              ...
              <div class="profit-calculator__field-input-wrapper">
                <input name="exchangeRateLtcUsed" type="text" inputmode="numeric" class="profit-calculator__field-input" />
                <div class="profit-calculator__field-input-btn-icon profit-calculator-exchange-rate-ltc-used-reset">
                  <svg width="24" height="24" viewBox="0 0 24 24"><path d="M2 12C2 16.97 6.03 21 11 21C13.39 21 15.68 20.06 17.4 18.4L15.9 16.9C14.63 18.25 12.86 19 11 19C4.76 19 1.64 11.46 6.05 7.05C10.46 2.64 18 5.77 18 12H15L19 16H19.1L23 12H20C20 7.03 15.97 3 11 3C6.03 3 2 7.03 2 12Z" fill="currentColor"></path></svg>
                </div>
              </div>
              <div class="profit-calculator__field-slider-wrapper profit-calculator__field-slider-wrapper--exchange-rate-ltc-used" style="visibility:hidden;">
                <input name="exchangeRateLtcUsedDiffSlider" type="text" class="profit-calculator__field-slider">
              </div>
            </div>
            <div class="profit-calculator__field profit-calculator__field--exchange-rate-doge-used">
              ...
              <div class="profit-calculator__field-input-wrapper">
                <input name="exchangeRateDogeUsed" type="text" inputmode="numeric" class="profit-calculator__field-input" />
                <div class="profit-calculator__field-input-btn-icon profit-calculator-exchange-rate-doge-used-reset">
                  <svg width="24" height="24" viewBox="0 0 24 24"><path d="M2 12C2 16.97 6.03 21 11 21C13.39 21 15.68 20.06 17.4 18.4L15.9 16.9C14.63 18.25 12.86 19 11 19C4.76 19 1.64 11.46 6.05 7.05C10.46 2.64 18 5.77 18 12H15L19 16H19.1L23 12H20C20 7.03 15.97 3 11 3C6.03 3 2 7.03 2 12Z" fill="currentColor"></path></svg>
                </div>
              </div>
              <div class="profit-calculator__field-slider-wrapper profit-calculator__field-slider-wrapper--exchange-rate-doge-used" style="visibility:hidden;">
                <input name="exchangeRateDogeUsedDiffSlider" type="text" class="profit-calculator__field-slider">
              </div>
            </div>
          <?php } ?>
          <div class="profit-calculator__field profit-calculator__field--exchange-rate-usdt-used">
            <div class="profit-calculator__field-label">USDT/RUB</div>
              <div class="profit-calculator__field-input-wrapper">
              <input name="exchangeRateUsdtUsed" type="text" inputmode="numeric" class="profit-calculator__field-input" />
              <div class="profit-calculator__field-input-btn-icon profit-calculator-exchange-rate-usdt-used-reset">
                <svg width="24" height="24" viewBox="0 0 24 24"><path d="M2 12C2 16.97 6.03 21 11 21C13.39 21 15.68 20.06 17.4 18.4L15.9 16.9C14.63 18.25 12.86 19 11 19C4.76 19 1.64 11.46 6.05 7.05C10.46 2.64 18 5.77 18 12H15L19 16H19.1L23 12H20C20 7.03 15.97 3 11 3C6.03 3 2 7.03 2 12Z" fill="currentColor"></path></svg>
              </div>
            </div>
            <div class="profit-calculator__field-slider-wrapper profit-calculator__field-slider-wrapper--exchange-rate-usdt-used" style="visibility:hidden;">
              <input name="exchangeRateUsdtUsedDiffSlider" type="text" class="profit-calculator__field-slider">
            </div>
          </div>
        </div>
      ...
      <p class="profit-calculator__footer-note preloader-block">Актуальный расчет на <span id="pc-date" class="preloader-text">—</span></p>
      <p class="profit-calculator__footer-note preloader-block">Расчёт носит предварительный характер и зависит от курса валют,<br>сложности сети и других рыночных факторов.</p>
    </div>
  </div>
</section>
    ...
    <div class="fullscreen-gallery__container">
        <div class="fullscreen-gallery__content">
            <div class="fullscreen-gallery__image-container">
                <img class="fullscreen-gallery__image" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="" style="display: none;"/>
