...
$headings = array();
if (!empty($content)) {
    // Ищем заголовки h2, h3, h4 с любыми атрибутами
    ...
    if (!empty($matches)) {
        foreach ($matches as $index => $match) {
            ...
            // Проверяем, что у заголовка еще нет ID
...
<!--    </div>-->
    ...
    <div class="page-blog-detail__block">
        ...
        <a href="" class="page-blog-detail__share-btn btn btn-primary js-open-popup-form" data-form-type="share" data-metric-goal="share_article">
                Поделиться статьей
            ...
            <div class="page-blog-detail__content article-content">
                <div class="article-content__section">
                    ...
                    if (!empty($headings)) {
                        ...
                        // Заменяем заголовки, добавляя ID
                        foreach ($headings as $heading) {
                            // Ищем точное совпадение открывающего тега заголовка
            ...
            <div class="contact-form-section">
                ...
                <form class="contact-form js-ajax-form" data-metric-goal="blog-contact-form">
                    ...
                    <div class="contact-form__field">
                        <input type="tel" name="client_phone" placeholder="Телефон" class="form-input js-phone-mask" required>
                    </div>
                    <div class="contact-form__field">
                        <textarea name="client_comment" placeholder="Комментарий (необязательно)" class="form__textarea" rows="4"></textarea>
                    </div>
            ...
            <div class="page-blog-detail__similar-articles">
                ...
                <div class="page-blog-detail__similar-grid">
                    <?php while ($similar = $similarArticles->GetNext()): ?>
                        <a href="/smi-o-nas/<?= $similar["CODE"] ?>/" class="page-blog-detail__similar-card-link">
    ...
    */
    ...
    <div class="page-blog-detail__filter">
        ...
        <div class="page-blog-detail__container">
            <div class="page-blog-detail__filter-buttons">
                ...
                ?>
                    <a href="<?= $section["SECTION_PAGE_URL"] ?>" class="page-blog-detail__filter-btn">
                        <?= $section["NAME"] ?>
                    </a>
                <?php 
                    endwhile;
    ...
    <div class="share-popup form-popup popup-form-wrapper" id="sharePopupFormWrapper" role="dialog" aria-modal="true"
        ...
        <!-- Полупрозрачная подложка для закрытия по клику вне окна -->
        ...
        <div class="share-popup__content">
            ...
            <!-- Сетка с иконками социальных сетей -->
            ...
            <div class="share-popup__copy-section">
                <div class="share-popup__copy-input-wrapper">
                    <input class="share-popup__copy-input" type="text" value="https://<?= $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>" readonly
                ...
                <button class="share-popup__copy-button btn-primary btn" type="button">
                    ...
                    <!-- Место для иконки "копировать" -->
                    <span class="share-popup__copy-button__icon" aria-hidden="true">
							<svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
								<rect x="0.609375" y="1" width="10" height="14" rx="2" stroke="white"
                                      stroke-opacity="0.5" />
								<path
                                        d="M4.60938 17.25V17.25C4.60938 18.2165 5.39288 19 6.35938 19H12.6094C13.7139 19 14.6094 18.1046 14.6094 17L14.6094 7C14.6094 5.89543 13.7139 5 12.6094 5V5"
                ...
                <div class="toast-notification" role="status" aria-live="polite">
                    <div class="toast-notification__icon-wrapper">
                        <!-- Место для иконки галочки -->
                        <span class="toast-notification__icon icon-success" aria-hidden="true">
								<svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
									<rect x="0.109375" width="24" height="24" rx="12" fill="#34C759" />
									<path d="M17.3594 8.25L10.6562 15L7.60938 11.9318" stroke="white" stroke-width="2"
                                          stroke-linecap="round" stroke-linejoin="round" />
								</svg>
							</span>
                    </div>
                    <p class="toast-notification__text">Ссылка скопирована</p>
                    <button class="toast-notification__close btn" type="button" aria-label="Закрыть уведомление">
                        <!-- Место для иконки крестика -->
                        <span aria-hidden="true">
								<svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
									<path d="M8.125 1.875L1.875 8.125" stroke="#6F7682" stroke-linecap="round"
                                          stroke-linejoin="round" />
									<path d="M1.875 1.875L8.125 8.125" stroke="#6F7682" stroke-linecap="round"
                                          stroke-linejoin="round" />
								</svg>
							</span>
                    </button>
