...
<footer class="site-footer footer">
	<div class="container">
		...
		<div class="footer__top">
			<div class="footer__main-info">
				<a href="/" class="logo footer__logo">
					...
					<img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/header/logo-wh.svg" alt="GIS Mining - Логотип компании" width="313" height="46">
				</a>
        ...
        <!-- PopUP basket -->
        <div class="page-asics__popup-form popup-form-wrapper js-cart-modal" id="cartPopupFormWrapper" style="display: none;">
            ...
            <form class="popup-form js-ajax-form" id="cartForm" data-metric-goal="send-cart-lead">
                ...
                <button type="button" class="popup-form__close-btn menu-close" id="closeCartPopupFormBtn" aria-label="Закрыть">
                    <span>
                ...
                <input type="text" name="client_name" id="cart_client_name_cart" placeholder="Имя" class="contact-form__input form-input" required aria-label="Имя">

                <label for="cart_client_phone_cart">Телефон*:</label>
                <input type="tel" name="client_phone" id="cart_client_phone_cart" placeholder="Телефон*" class="contact-form__input form-input js-phone-mask" required aria-label="Номер телефона">

                <label for="cart_client_email">Email:</label>
                <input type="email" name="client_email" id="cart_client_email" placeholder="your@email.com (необязательно)" class="contact-form__input form-input" aria-label="Электронная почта">
              ...
              <input type="checkbox" id="privacy-policy-footer" name="privacy-policy" class="form-check-input" required>
...
<div class="modal-overlay" id="mainSuccessModalOverlay">
    <div class="modal" id="mainSuccessModal">
        ...
        <!-- PopUp Рассрочка -->
<div class="page-business__popup-form popup-form-wrapper js-cart-modal" id="rassrochkaPopupFormWrapper" style="display: none;">

    <!-- ВАЖНО: У формы теперь есть класс js-ajax-form, чтобы ее "подхватил" form-actions.js -->
    <form class="popup-form js-ajax-form" id="rassrochka_form" data-metric-goal="send-rassrochka-lead">

        <button type="button" class="popup-form__close-btn menu-close" id="closeRassrochkaPopupFormBtn" aria-label="Закрыть">
                    <span>
                        <svg aria-hidden="true" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17 1L1 17M1 1L17 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
        ...
        <p class="popup-form__cta">Без первоначального взноса на 3, 6 или 12 месяцев. Заполните форму и получите подробные условия рассрочки</p>

        <label for="cart_client_name_rassrochka">Ваше имя*:</label>
        <input type="text" name="client_name" id="cart_client_name_rassrochka" placeholder="Имя" class="contact-form__input form-input" required aria-label="Имя">

        <label for="cart_client_phone_rassrochka">Телефон*:</label>
        <input type="tel" name="client_phone" id="cart_client_phone_rassrochka" placeholder="Телефон*" class="contact-form__input form-input js-phone-mask" required aria-label="Номер телефона">
        ...
        <div class="social-links seo-hidden-links" id="siteSocialLinks">
            ...
            <ul class="social-links__list">
                ...
                <li class="social-links__item">
                    <a href="https://www.instagram.com/gismining?igsh=a2loOTI4bG1oMG92" target="_blank" rel="noopener noreferrer nofollow"
                ...
                <li class="social-links__item">
                    <a href="https://ru.tradingview.com/u/GIS-Mining/#settings-profile" target="_blank" rel="noopener noreferrer nofollow"
                ...
                <li class="social-links__item">
                    <a href="https://dzen.ru/user/wz4h9o1t6gyei9xirsrwh20ctri" target="_blank" rel="noopener noreferrer nofollow"
...
">
    <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 15px; flex-wrap: wrap;">
        <div style="
            ...
            color: #333;
        ">
            Мы используем <a href="/cookie/" target="_blank" style="color:#5b61ff;text-decoration:underline;">файлы cookie</a>, 
            чтобы обеспечивать правильную работу сайта и анализировать сетевой трафик.<br>Продолжая работу на сайте, вы соглашаетесь с
            <a href="/policy-confidenciales/" target="_blank" style="color:#5b61ff;text-decoration:underline;">политикой конфиденциальности</a>.
        </div>
...
<!-- Schema.org Microdata (Organization - для всего сайта) -->
<script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "Organization",
    "name": "GIS Mining",
    "url": "https://gis-mining.ru/",
    "logo": "https://gis-mining.ru/img/header/logo_header_white.png",
    "contactPoint": {
        "@type": "ContactPoint",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebSite",
  "@id": "https://gis-mining.ru/#website",
  "url": "https://gis-mining.ru/",
  "name": "GIS Mining",
  "publisher": {
    "@id": "https://gis-mining.ru/#org"
  },
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://gis-mining.ru/search/?q={search_term_string}",
