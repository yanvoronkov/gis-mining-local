...
use Bitrix\Main,
	...
	file_put_contents($_SERVER['DOCUMENT_ROOT'].'/yandex_log.txt', "LOCAL FILE LOADED\n", FILE_APPEND);
...
{
    // Разрешаем товары без цен
    $row['OFFERS'][$offerId]['RESULT_PRICE'] = [
        'MIN_PRICE' => 0,
        'FULL_PRICE' => 0,
        'CURRENCY' => $BASE_CURRENCY,
    ];
    // НЕ удаляем предложение
}
