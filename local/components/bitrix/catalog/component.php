...
if ($arParams["SEF_MODE"] === "Y") {
	...
	// Обработка страницы калькулятора - используем шаблон element.php,
	// но устанавливаем флаг CALCULATOR_PAGE для переключения на calculator.php внутри шаблона
	if ($componentPage === "calculator") {
		// Сохраняем флаг, что это страница калькулятора
		$arVariables["CALCULATOR_PAGE"] = "Y";
		// Перенаправляем на element.php, который проверит этот флаг
