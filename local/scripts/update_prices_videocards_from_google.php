 ...
 */
function UpdateVideocardsPricesAgent() {
    ...
    if (!\Bitrix\Main\Loader::includeModule('iblock') || !\Bitrix\Main\Loader::includeModule('catalog')) {
        ...
        return "UpdateVideocardsPricesAgent();"; // Повторить через час
    }

    // --- Настройки ---
    $googleSheetUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS3ZNwvIHIrnqfxlMgNFQJltIHLfYnAaWIQVS0eaGdvAROsmuak4x4tAZefiW4lh7gx6J99AaplivIZ/pub?gid=7156598&single=true&output=csv';
    $iblockIdsToSearch = [11]; // !!! УКАЖИТЕ ID ВСЕХ ВАШИХ ИНФОБЛОКОВ С ТОВАРАМИ !!!
    ...
    if ($csvData === false) {
        ...
        return "UpdateVideocardsPricesAgent();";
    }
    ...
    \Bitrix\Main\Diag\Debug::writeToFile($logMessage, "", "update_prices_video.log");
