...
$APPLICATION->SetPageProperty("TITLE", "Майнинг-отель GIS Mining — размещение оборудования для майнинга в дата-центре");
$APPLICATION->SetTitle("Майнинг-отель GIS Mining — размещение оборудования для майнинга в дата-центре");
// Хлебные крошки теперь формируются автоматически в header
$APPLICATION->SetPageProperty("description", "Надёжный майнинг-отель для размещения ASIC-оборудования. Тарифы от 4,39 ₽/кВт·ч, стабильное питание от Калининской АЭС, охрана и круглосуточная техподдержка.");
...
$APPLICATION->SetPageProperty("OG:TITLE", "РМайнинг-отель GIS Mining — размещение оборудования для майнинга в дата-центре");
$APPLICATION->SetPageProperty("OG:DESCRIPTION", "Надёжный майнинг-отель для размещения ASIC-оборудования. Тарифы от 4,39 ₽/кВт·ч, стабильное питание от Калининской АЭС, охрана и круглосуточная техподдержка.");
...
$APPLICATION->SetPageProperty("TWITTER:TITLE", "Майнинг-отель GIS Mining — размещение оборудования для майнинга в дата-центре");
$APPLICATION->SetPageProperty("TWITTER:DESCRIPTION", "Надёжный майнинг-отель для размещения ASIC-оборудования. Тарифы от 4,39 ₽/кВт·ч, стабильное питание от Калининской АЭС, охрана и круглосуточная техподдержка.");
...
$APPLICATION->AddChainItem("Майнинг-отель");
...
?>
            ...
            <div class="hero-section__text-wrapper">
                <ul class="hero-section__benefits">
                    <li class="hero-section__item">
                        <div class="hero-section__icon-wrapper">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.4982 16.0576C12.0854 16.0576 11.7348 15.9101 11.4464 15.6151C11.1579 15.3201 11.0136 14.9662 11.0136 14.5534C11.0136 14.134 11.1585 13.779 11.4482 13.4886C11.7378 13.1981 12.089 13.0529 12.5019 13.0529C12.9321 13.0529 13.2924 13.1987 13.5829 13.4904C13.8733 13.782 14.0185 14.1376 14.0185 14.557C14.0185 14.9699 13.8727 15.3232 13.581 15.6169C13.2894 15.9107 12.9284 16.0576 12.4982 16.0576ZM8.46775 7.77241H16.5646L18.6198 3.64584H6.39639L8.46775 7.77241ZM8.79613 21.3542H16.23C17.6531 21.3542 18.8656 20.8527 19.8675 19.8498C20.8692 18.8468 21.3701 17.6304 21.3701 16.2005C21.3595 15.5899 21.254 15.0052 21.0537 14.4464C20.8533 13.8873 20.5549 13.3728 20.1584 12.9026L16.881 8.95444H8.1352L4.84171 12.9026C4.46254 13.3728 4.16844 13.8873 3.95942 14.4464C3.75039 15.0052 3.64587 15.5899 3.64587 16.2005C3.64587 17.6304 4.14735 18.8468 5.1503 19.8498C6.15325 20.8527 7.36853 21.3542 8.79613 21.3542Z" fill="white"/>
                            </svg>
                        </div>
                    ...
                    <li class="hero-section__item">
                        <div class="hero-section__icon-wrapper">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.4346 22.3958L9.96403 19.2648C9.60743 19.1433 9.22349 18.9667 8.81221 18.7349C8.40075 18.5033 8.04615 18.2579 7.74841 17.9987L4.83564 19.325L2.75439 15.645L5.38669 13.7081C5.35196 13.5251 5.32688 13.3253 5.31143 13.1088C5.29615 12.8925 5.28851 12.6929 5.28851 12.5099C5.28851 12.3337 5.29615 12.1374 5.31143 11.9211C5.32688 11.7048 5.35196 11.495 5.38669 11.2919L2.75439 9.34504L4.83564 5.69504L7.73825 7.00129C8.05613 6.74209 8.41412 6.49834 8.81221 6.27004C9.21012 6.04174 9.59068 5.87212 9.95387 5.76119L10.4346 2.60416H14.5653L15.0359 5.7453C15.4192 5.8868 15.8026 6.0624 16.1859 6.27212C16.5691 6.48167 16.9143 6.72473 17.2216 7.00129L20.1742 5.69504L22.2455 9.34504L19.5731 11.2799C19.6212 11.4871 19.6514 11.6954 19.6635 11.9049C19.6755 12.1147 19.6815 12.313 19.6815 12.5C19.6815 12.6802 19.6738 12.8725 19.6583 13.0768C19.643 13.2812 19.6146 13.4936 19.5731 13.7141L22.2354 15.645L20.1541 19.325L17.2216 17.9888C16.8969 18.2612 16.5467 18.5126 16.1708 18.743C15.7949 18.9733 15.4166 19.1439 15.0359 19.2547L14.5653 22.3958H10.4346ZM12.47 15.4346C13.2872 15.4346 13.9806 15.1498 14.5502 14.5802C15.1198 14.0108 15.4047 13.3174 15.4047 12.5C15.4047 11.6826 15.1198 10.9892 14.5502 10.4198C13.9806 9.85016 13.2872 9.56535 12.47 9.56535C11.6593 9.56535 10.9674 9.85016 10.3945 10.4198C9.82176 10.9892 9.53538 11.6826 9.53538 12.5C9.53538 13.3174 9.82176 14.0108 10.3945 14.5802C10.9674 15.1498 11.6593 15.4346 12.47 15.4346Z" fill="white"/>
                            </svg>
                        </div>
                    ...
                    <li class="hero-section__item">
                        <div class="hero-section__icon-wrapper">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 12.1635C11.4974 12.1635 10.6708 11.8383 10.0203 11.1878C9.36979 10.5371 9.04453 9.71051 9.04453 8.70808C9.04453 7.6987 9.36979 6.8704 10.0203 6.22318C10.6708 5.57596 11.4974 5.25235 12.5 5.25235C13.5026 5.25235 14.3292 5.57596 14.9797 6.22318C15.6302 6.8704 15.9555 7.6987 15.9555 8.70808C15.9555 9.71051 15.6302 10.5371 14.9797 11.1878C14.3292 11.8383 13.5026 12.1635 12.5 12.1635ZM4.6875 20.1122V18.1349C4.6875 17.5754 4.83576 17.0879 5.13229 16.6727C5.42882 16.2574 5.81406 15.9382 6.28802 15.7151C7.38455 15.2278 8.44158 14.8605 9.45911 14.6133C10.4768 14.3662 11.4905 14.2427 12.5 14.2427C13.5095 14.2427 14.5205 14.3689 15.5328 14.6214C16.5451 14.8738 17.5995 15.2384 18.6958 15.7151C19.1806 15.9382 19.5712 16.2574 19.8677 16.6727C20.1642 17.0879 20.3125 17.5754 20.3125 18.1349V20.1122H4.6875Z" fill="white"/>
                            </svg>
                        </div>
                    ...
                    <li class="hero-section__item">
                        <div class="hero-section__icon-wrapper">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 22.3758C10.2365 21.7614 8.36849 20.4175 6.89609 18.3443C5.4237 16.271 4.6875 13.9717 4.6875 11.4463V5.569L12.5 2.64426L20.3125 5.569V11.4463C20.3125 13.9717 19.5763 16.271 18.1039 18.3443C16.6315 20.4175 14.7635 21.7614 12.5 22.3758ZM12.5 21.1518C14.2936 20.5641 15.7853 19.4704 16.9753 17.8706C18.165 16.2707 18.8608 14.4805 19.0625 12.5H12.5V3.92629L5.86953 6.39217V11.4463C5.86953 11.6413 5.87387 11.8126 5.88255 11.9601C5.89123 12.1077 5.90955 12.2877 5.9375 12.5H12.5V21.1518Z" fill="white"/>
                            </svg>
                        </div>
    ...
    <section class="servises section-padding container">
        <div class="servises__items">
            <a href="https://gis-mining.ru/catalog/asics/" class="servises__item-link">
            ...
            <a href="https://gis-mining.ru/mining-investicii/" class="servises__item-link">
                <div class="servises__img-wrapper">
                    <picture>
    ...
    <section class="feedback container section-padding">
        ...
        <div class="feedback__contact-form-wrapper">
            ...
            <form id="contactFormMiningHotel" class="feedback__contact-form js-ajax-form">
                ...
                <input type="hidden" name="source_id" value="47">
    ...
    <div class="form-popup popup-form-wrapper" id="mainPopupFormWrapper" style="display: none;">
        <div class="form-popup__items">
            ...
            <form class="form-popup__popup-form js-ajax-form" id="contactFormPopup"
                  data-metric-goal="mining-hotel-lead">
