                ...
                <div class="partnership-item">
                    ...
                    <div class="partnership-item__content">
                        ...
                        <p class="partnership-item__description">
                            ...
                            Наша площадка для майнинга построена по строгим стандартам атомной отрасли и считается одним из самых безопасных дата-центров России.<br>
                            <strong>Официальные поставки оборудования с полным таможенным оформлением (ГТД РФ) и НДС.</strong><br>
                            Питание от АЭС по выгодным тарифам, стабильный интернет, круглосуточная поддержка и современные системы безопасности
...
<!--                </video>-->
            ...
            <div class="company-intro__text-block">
                ...
                <p>Специализируемся на официальных поставках майнинг-оборудования с полным пакетом документов (ГТД РФ, НДС) для российского рынка.</p>
