...
<form action="<?echo $APPLICATION->GetCurUri();?>" method="post" enctype="multipart/form-data" name="field_settings">
	...
	<table width="100%" class="kda-ie-list-settings">
		...
		<tr class="heading">
			<td colspan="2">
				<?echo GetMessage("KDA_IE_LAUTH_HEADERS"); ?>
			</td>
		</tr>
		<?
		...
		foreach($AUTH_SETTINGS['HEADERS'] as $var=>$value)
		{
			...
			<tr class="kda-ie-lauth-var">
				<td class="adm-detail-content-cell-l">
					<?echo GetMessage("KDA_IE_LAUTH_HEADER");?>:
		...
		?>
		<tr>
			<td colspan="2" class="kda-ie-email-checkparams kda-ie-lauth-addheader">
				<a href="javascript:void(0)" onclick="EProfile.LauthAddVar(this)"><?echo GetMessage("KDA_IE_LAUTH_ADD_HEADER");?></a>
			</td>
		</tr>
