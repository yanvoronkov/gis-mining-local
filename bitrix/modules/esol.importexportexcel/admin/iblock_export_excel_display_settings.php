...
function GetFieldEextraVal($arSettings, $name)
{
	$listIndex = htmlspecialcharsex($_REQUEST['list_index']);
	$fieldKey = htmlspecialcharsex($_REQUEST['key']);
	$fnBase = '[DISPLAY_PARAMS]['.$listIndex.']['.$fieldKey.']';
	$fName = 'SETTINGS'.$fnBase.'['.$name.']';
...
if($_POST['action']=='save' && is_array($_POST['SETTINGS']))
{
	...
	ob_end_clean();
	$returnJson = (empty($_POST['SETTINGS']['DISPLAY_PARAMS'][$listIndex]) ? '""' : \KdaIE\Utils::PhpToJSObject($_POST['SETTINGS']['DISPLAY_PARAMS'][$listIndex]));
	...
	<table width="100%">
		...
		<?if($fieldKey=='SECTION_PATH'){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'SECTION_PATH_SEPARATOR');
					?>
		...
		<?if(strpos($fieldKey, 'TEXT_ROWS_TOP')===0){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'HIDE_UNDER_GROUP');
					?>
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<?
				list($fName, $val) = GetFieldEextraVal($SETTINGS, 'TEXT_ALIGN');
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<?
				list($fName, $val) = GetFieldEextraVal($SETTINGS, 'VERTICAL_ALIGN');
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<?
				list($fName, $val) = GetFieldEextraVal($SETTINGS, 'ROW_HEIGHT');
				?>
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<?
				list($fName, $val) = GetFieldEextraVal($SETTINGS, 'ROW_HIDDEN');
				?>
				<input type="hidden" name="<?=$fName?>" value="N">
				<input type="checkbox" name="<?=$fName?>" value="Y" <?if($val=='Y'){echo 'checked';}?>>
			</td>
		...
		<?if($fieldType!='image'){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'FONT_FAMILY');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'FONT_SIZE');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'FONT_COLOR');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'BACKGROUND_COLOR');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'STYLE_BOLD');
					?>
					<input type="hidden" name="<?=$fName?>" value="N">
					<input type="checkbox" name="<?=$fName?>" value="Y" <?if($val=='Y'){echo 'checked';}?>>
				</td>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'STYLE_ITALIC');
					?>
					<input type="hidden" name="<?=$fName?>" value="N">
					<input type="checkbox" name="<?=$fName?>" value="Y" <?if($val=='Y'){echo 'checked';}?>>
				</td>
		...
		<?if($fieldType=='image'){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'PICTURE_WIDTH');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsex($val)?>">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					list($fName, $val) = GetFieldEextraVal($SETTINGS, 'PICTURE_HEIGHT');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsex($val)?>">
				</td>
			</tr>
