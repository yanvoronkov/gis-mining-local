...
class CKDAImportExcelRollback extends CKDAImportExcel {
	...
	public function RestoreRecord($arRecord)
	{
		...
		$arFields = \KdaIE\Utils::Unserialize($arRecord['FIELDS'], true);
	...
	public function RestoreSectionUpdate($ID, $arFields)
	{
		...
		if(isset($arFields['PICTURE'])) unset($arFields['PICTURE']);
		if(isset($arFields['DETAIL_PICTURE'])) unset($arFields['DETAIL_PICTURE']);
