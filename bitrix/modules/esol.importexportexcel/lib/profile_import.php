		...
		return array(
			...
			'GROUP' => new Entity\ReferenceField(
				...
				array(
					...
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileGroupTable::TYPE_IMPORT_IBLOCK)
				),
			...
			'PROFILE_EXEC' => new Entity\ReferenceField(
				...
				array(
					...
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileExecTable::TYPE_IBLOCK)
				),
				array('join_type' => 'LEFT')
			),
			...
			'PROFILE_RIGHTS' => new Entity\ReferenceField(
				...
				array(
					'=this.ID' => 'ref.PROFILE_ID',
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileRightsTable::TYPE_IMPORT_IBLOCK)
				),
				array('join_type' => 'LEFT')
			),
		);
