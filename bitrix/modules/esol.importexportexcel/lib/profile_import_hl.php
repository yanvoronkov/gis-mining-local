	...
	public static function getMap()
	{
		return array(
			...
			'GROUP' => new Entity\ReferenceField(
				'GROUP',
				'\Bitrix\KdaImportexcel\ProfileGroupTable',
				array(
					'=this.GROUP_ID' => 'ref.ID',
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileGroupTable::TYPE_IMPORT_HLBLOCK)
				),
			...
			'PROFILE_EXEC' => new Entity\ReferenceField(
				...
				array(
					'=this.ID' => 'ref.PROFILE_ID',
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileExecTable::TYPE_HLBLOCK)
				),
				array('join_type' => 'LEFT')
			),
			'PROFILE_RIGHTS' => new Entity\ReferenceField(
				'PROFILE_RIGHTS',
				'\Bitrix\KdaImportexcel\ProfileRightsTable',
				array(
					'=this.ID' => 'ref.PROFILE_ID',
					'=ref.PROFILE_TYPE' => new \Bitrix\Main\DB\SqlExpression('?i', \Bitrix\KdaImportexcel\ProfileRightsTable::TYPE_IMPORT_HLBLOCK)
				),
				array('join_type' => 'LEFT')
			),
		);
