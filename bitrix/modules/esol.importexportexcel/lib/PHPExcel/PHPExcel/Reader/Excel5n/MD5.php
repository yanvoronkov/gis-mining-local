...
/**
 * KDAPHPExcel_Reader_Excel5n_MD5
 *
 ...
 */
class KDAPHPExcel_Reader_Excel5n_MD5
{
    // Context
    private $a;
    private $b;
    ...
    public function add($data)
    {
        ...
        $F = array('KDAPHPExcel_Reader_Excel5n_MD5','f');
        $G = array('KDAPHPExcel_Reader_Excel5n_MD5','g');
        $H = array('KDAPHPExcel_Reader_Excel5n_MD5','h');
        $I = array('KDAPHPExcel_Reader_Excel5n_MD5','i');
