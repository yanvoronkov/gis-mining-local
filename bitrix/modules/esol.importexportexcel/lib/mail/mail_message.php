...
class MailMessage
{
	...
	{
		$headerP = IUtils::binStrpos($message, "\r\n\r\n");

		$rawHeader = IUtils::binSubstr($message, 0, $headerP);
		$body      = IUtils::binSubstr($message, $headerP+4);
		...
		if ($header->IsMultipart())
		{
			...
			$startP = IUtils::binStrpos($message, $startB)+IUtils::BinStrlen($startB);
			$endP   = IUtils::binStrpos($message, $endB);

			$data = IUtils::binSubstr($message, $startP, $endP-$startP);
