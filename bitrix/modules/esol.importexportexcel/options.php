...
if($USER->IsAdmin())
{
	...
	if(is_string($arTransParams) && !empty($arTransParams)) $arTransParams = unserialize($arTransParams, ['allowed_classes'=>[]]);
	...
	<tr>
		<td width="50%"><? echo Loc::getMessage('KDA_IE_SHOW_PROFILES_IN_MAIN_MENU'); ?></td>
		<td width="50%">
			<input type="hidden" name="SETTINGS[SHOW_PROFILES_IN_MAIN_MENU]" value="N">
			<input type="checkbox" name="SETTINGS[SHOW_PROFILES_IN_MAIN_MENU]" value="Y" <?if(COption::GetOptionString($moduleId, 'SHOW_PROFILES_IN_MAIN_MENU', 'N')=='Y'){echo 'checked';}?>>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			&nbsp; <a href="https://esolutions.su/marketplace/oauth.php?get_token=1" target="_blank"><? echo Loc::getMessage('KDA_IE_OPTIONS_GOOGLE_DRIVE_APIKEY_GET'); ?></a> <?/* echo Loc::getMessage('KDA_IE_OPTIONS_GOOGLE_DRIVE_APIKEY_GET_MORE'); */?>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2" align="center">
			<table border="1" cellpadding="5" class="kda-options-rels-table">
				...
				<?
				$arProxies = unserialize(COption::GetOptionString($moduleId, 'PROXIES'), ['allowed_classes'=>[]]);
