...
if (empty($elementCode)) {
    ...
    $elementCode = str_replace('/cases/', '', $elementCode);
...
if ($article) {
    ...
    // Keywords
    $keywords = "кейсы, майнинг, криптовалюта, ASIC, оборудование";
    ...
    $APPLICATION->SetTitle("Кейс не найден");
...
<?php if ($article): ?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            "COMPONENT_TEMPLATE" => "cases_detail",
            "DETAIL_URL" => "",
            "AJAX_MODE" => "N",
            "AJAX_OPTION_JUMP" => "N",
            "AJAX_OPTION_STYLE" => "Y",
...
<?php else: ?>
    <div class="article-not-found">
        ...
        <p>Запрашиваемый кейс не существует или был удален.</p>
        <a href="/cases/" class="back-to-blog">← Вернуться к кейсам</a>
    </div>
