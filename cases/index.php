...
$APPLICATION->SetPageProperty("TITLE", "Кейсы — Gis Mining");
$APPLICATION->SetTitle("Кейсы");
$APPLICATION->SetPageProperty("description", "Кейсы компании Gis Mining: примеры реализованных проектов, истории успеха и результаты работы.");
$APPLICATION->SetPageProperty("keywords", "кейсы майнинг, примеры работ, портфолио gis mining");
$APPLICATION->SetPageProperty("robots", "index, follow");

// --- OPEN GRAPH МЕТА-ТЕГИ ---

$APPLICATION->SetPageProperty("OG:TITLE", "Кейсы — Gis Mining");
$APPLICATION->SetPageProperty("OG:DESCRIPTION", "Кейсы компании Gis Mining: примеры реализованных проектов, истории успеха и результаты работы.");
...
$APPLICATION->SetPageProperty("TWITTER:TITLE", "Кейсы — Gis Mining");
$APPLICATION->SetPageProperty("TWITTER:DESCRIPTION", "Кейсы компании Gis Mining: примеры реализованных проектов, истории успеха и результаты работы.");
...
<?php
// Получаем ID инфоблока "cases"
$blogIblockId = 14;

// Определяем ID инфоблока cases по коду, если вдруг ID изменится (хотя мы задали жестко 14)
$iblock = CIBlock::GetList(
    array("SORT" => "ASC"),
    array("CODE" => "cases", "ACTIVE" => "Y")
)->GetNext();
...
<?php else: ?>
    ...
    <div class="no-blog-message">
        <h2>Раздел не настроен</h2>
        <p>Пожалуйста, создайте инфоблок "cases" в административной панели Битрикса.</p>
    </div>
